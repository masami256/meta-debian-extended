...
DEPENDS_prepend = "cmake-latest-native "
B = "${WORKDIR}/build"
...
CMAKE_BUILD_PARALLEL_LEVEL_task-compile-ptest-base = "${@oe.utils.parallel_make(d, False)}"
CMAKE_BUILD_PARALLEL_LEVEL_task-install-ptest-base = "${@oe.utils.parallel_make(d, True)}"
