...
# Based on https://github.com/yoctoproject/poky/blob/c5f4a2b2287cb56aa9a2acc0e54d48e0e9e7cd44/meta/recipes-devtools/llvm/llvm_git.bb
...
DEPENDS = "libffi libxml2 zlib libedit ninja-native llvm-toolchain-13-native"
...
inherit debian-package cmake pkgconfig
require recipes-debian/sources/llvm-toolchain-13.inc
...
DEBIAN_UNPACK_DIR = "${WORKDIR}/${BPN}_${PV}"
S = "${DEBIAN_UNPACK_DIR}/llvm"
#S = "${DEBIAN_UNPACK_DIR}"
#S = "${WORKDIR}/git/llvm"
...
DEBUG_FLAGS_append = "${@oe.utils.vartrue('DEBUG_BUILD', '', ' -g1', d)}"
